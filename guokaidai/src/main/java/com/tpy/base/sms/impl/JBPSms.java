...
import com.tpy.base.util.Client;
 ...
 * 
 */
public class JBPSms implements SmsProxy {
...
//    	String result=client.sendSms(parseTelNo(telNos), parseContent(content), "");
    	String result=client.sendSms(parseTelNo(telNos), content, "");
