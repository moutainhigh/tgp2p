...
public class PaymentReturnInfo {
	...
	public String getSignmd5() {
			...
			String sign = "billno"+this.billno+"currencytype"+this.Currency_type+"amount"+this.amount+"date"+this.date+"succ"+this.succ+"ipsbillno"+this.ipsbillno+"retencodetype"+this.retencodetype+ com.tpy.p2p.pay.util.ParameterIps.getCertificatem();
