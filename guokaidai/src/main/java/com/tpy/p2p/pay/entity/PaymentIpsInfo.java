...
public class PaymentIpsInfo {
	...
	public String getMer_code() {
		return com.tpy.p2p.pay.util.ParameterIps.getMercode();
	}
	...
	public String getMerchanturl() {
		return com.tpy.p2p.pay.util.ParameterIps.getUrl();
	}
	...
	public String getServerUrl() {
		return com.tpy.p2p.pay.util.ParameterIps.getAsynchronismurl();
	}
	public String getSignMD5() {
			//SignMD5明文=billno+订单编号+currencytype +支付币种+amount +金额(保留2位小数)+ date +日期+orderencodetype +【订单支付接口加密方式】+IPS证书 
			String signmd5 = "billno"+this.billno+"currencytype"+this.currency_Type+"amount"+this.amount+"date"+this.date+"orderencodetype"+this.orderEncodeType+ com.tpy.p2p.pay.util.ParameterIps.getCertificatem();
