...
import com.tpy.p2p.pay.util.SystemConfig;
import com.tpy.p2p.chesdai.entity.Userbasicsinfo;
...
public class GenerateLinkUtils {
    ...
    public static String generateActivateLink(Userbasicsinfo user,
    	...
    	//return getServiceHostnew(request)+"registration/activateAccount?activationid=" + user.getId() + "&" + CHECK_CODE + "=" + generateCheckcode(user);

        return SystemConfig.server_domain + "/registration/activateAccount?activationid=" + user.getId() + "&" + CHECK_CODE + "=" + generateCheckcode(user);
    ...
    public static String generateUptEmailLink(Userbasicsinfo user,
        ...
        String str = com.tpy.base.util.StringUtil.generatePassword("" + user.getId());
