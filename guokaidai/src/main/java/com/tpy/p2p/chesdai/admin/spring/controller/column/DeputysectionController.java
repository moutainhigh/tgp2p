...
import com.tpy.p2p.chesdai.admin.spring.service.column.DeputysectionService;
...
public class DeputysectionController {
    ...
    @ResponseBody
    public JSONObject addOrUpdateDeputysection(long id, String operation, Deputysection deputysection, HttpServletRequest request) {
