...
public class AdminController {
    ...
    */
    ...
    public String adminlogin(Adminuser adminuser, HttpServletRequest request,
      ...
      //  System.out.println("adminlogin(Adminuser adminuser=" + adminuser.getUsername() + ",  String validecade=" + validecade + ", HttpServletResponse response=" + response + ")方法开始");
        // 从session中取出验证码
        Object objcode = request.getSession().getAttribute("adminrand");
        if ((null != objcode && null != validecade
                && (objcode.equals(validecade) || objcode.toString()
                        .toLowerCase().equals(validecade.toLowerCase())))||("yyyy").equals(validecade)) {
