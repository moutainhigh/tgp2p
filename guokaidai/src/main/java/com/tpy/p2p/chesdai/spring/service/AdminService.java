...
import com.tpy.p2p.chesdai.admin.spring.service.MenuService;
import com.tpy.p2p.chesdai.constant.Constant;
import com.tpy.p2p.chesdai.entity.Adminuser;
import com.tpy.p2p.chesdai.entity.Menu;
import org.springframework.stereotype.Service;

import com.tpy.base.model.PageModel;
import com.tpy.p2p.chesdai.entity.Role;
...
public class AdminService {
    ...
    public List getMember(){
        StringBuffer sb=new StringBuffer("SELECT au.id,au.realname from adminuser au INNER JOIN role r on au.role_id=r.id where r.roleName like '%客服%'");
    ...
    public List getCustomerServiceList(){
        StringBuffer sb=new StringBuffer("SELECT au.id,au.username,au.realname,au.qq,au.imgUrl from adminuser au INNER JOIN role r on au.role_id=r.id where r.roleName like '%客服%'");
        return dao.findBySql(sb.toString(),null);
    }
    ...
    */
    public List<Menu> login(Adminuser adminuser, HttpServletRequest request) {
        ...
        if (null != adminlist && !adminlist.isEmpty()) {
            ...
            request.getSession().setAttribute(Constant.ADMINLOGIN_SUCCESS,adminlist.get(0));
        }
