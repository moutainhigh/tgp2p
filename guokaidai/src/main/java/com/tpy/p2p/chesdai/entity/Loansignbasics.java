...
//	/**借款管理费比例*/
   ...
   private Double guaranteesAmt;
	...
	public Loansignbasics(Loansign loansign, String loanNumber,
			...
			String creditTime, String loanExplain, String loanSignTime,
			Integer loanCategory, Double mgtMoney,String pBidNo,String pContractNo,Integer bidTime,Long views, Double mgtMoneyScale) {
