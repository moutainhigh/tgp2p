...
public class DwzResponseUtil {
	...
	public static JSONObject setJson(JSONObject json, String statusCode, String message, String navTabId,String callbackType,String forwardUrl){
		json.element("statusCode", statusCode);
		json.element("message", message);
		json.element("navTabId", navTabId);
		if(callbackType != ""){
		...
		json.element("forwardUrl", forwardUrl);
		return json;
	}
}
