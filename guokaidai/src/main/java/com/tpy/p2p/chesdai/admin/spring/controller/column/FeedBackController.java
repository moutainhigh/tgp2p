...
import com.tpy.p2p.chesdai.admin.spring.controller.PageUrlController;
import com.tpy.p2p.chesdai.admin.spring.controller.UserInfoController;
import com.tpy.p2p.chesdai.entity.Feedbackinfo;
...
public class FeedBackController {
    ...
    public JSONObject sendResetEmail(String replyContext,long fid,HttpServletRequest request)
        ...
        try {
         ...
         // 发送邮件链接地址
            emailService.sendEmail("太平洋理财邮件反馈回复", replyContext, feedbackinfo.getEmail());
