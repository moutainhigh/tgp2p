...
<script type="text/javascript" src="/resources/js/loanSign/dcbloanSign.js"></script>
<style>
/*#loanstate{
...
<div layoutH="0" class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/loanSign/seeDcbLoansignDetails?operNumber=1" target="navTab" height="500" width="750" rel="addloanSign" mask="true"><span>添加</span></a></li>
	...
	-->
	<table id="mygrid12"></table>
	
	<table id="mygrid13"></table>
	<!--
	<div class="panelBar">
		<ul class="toolBar">
			<li>
